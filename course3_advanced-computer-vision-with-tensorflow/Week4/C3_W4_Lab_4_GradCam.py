...
def get_CAM(processed_image, actual_label, layer_name='block5_conv3'):
    '''
    functions to output the maps. 
    get_CAM() is the function highlighted in the lectures and takes care 
    - of generating the heatmap of gradient weighted features. 
    show_random_sample() takes care of plotting the results
    '''
...
def show_sample(idx=None):
    ...
    plt.tight_layout()
    plt.show()
    plt.savefig("results/gradcam_activations.png")
  
    return activations

def visualize_intermediate_activations(layer_names, activations):
    '''
    utility function below to visualize the activations in the intermediate layers you defined earlier. 
    ...
    plt.show()
    plt.savefig("results/gradcam_intermediate_results.png")
...
if __name__ == "__main__":
    ...
    # steps to generate the class activation maps.
